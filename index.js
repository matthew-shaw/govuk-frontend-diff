...
const { argv } = yargs
  ...
  .usage('Usage: $0 http://localhost:3000 --govuk-frontend-version=v5.0.0')
  .usage(
    'Usage: $0 http://localhost:3000 --govuk-frontend-version=v5.0.0 --exclude=page-template'
  )
  .option('govuk-frontend-version', {
    describe: `Version of govuk-frontend to test against.    
    This will normally be references to tags like v5.0.0 but this will accept any commit-ish such as branches or even commit identifiers.
